...
async function getSongs(folder) {
    ...
    try {
        ...
        console.log("Loaded songs from", folder, "- Count:", songs.length, "- Songs:", songs)
    } catch (err) {
...
async function displayAlbums() {
    ...
    for (let index = 0; index < array.length; index++) {
        ...
        // Extract folder name from URL like http://127.0.0.1:5500/songs/ncs/
        if (href.includes("/songs/")) {
            let parts = href.split("/songs/")[1].split("/").filter(p => p);
            ...
            try {
                ...
                console.log("Error loading album:", folder, err.message);
            }
        }
    }
